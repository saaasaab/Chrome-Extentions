...
function handleResize(numCols,   numCells) {
...
function Gridgoal( {selectedGoal} ) {
    ...
    const [numCells, setNumCells] = useState(String(goal.value));
    ...
    useEffect(() => {
        ...
        window.addEventListener('resize', () => { handleResize(dimensions[0],  dimensions[2] ) });
