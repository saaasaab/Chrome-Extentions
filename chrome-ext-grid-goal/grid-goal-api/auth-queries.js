...
function getUsernameId(connection, username){
    const query = `SELECT id FROM users WHERE username = ?;`;
    return connection.q(query, [username]);
}

function createUserAccount(connection, username, password){
